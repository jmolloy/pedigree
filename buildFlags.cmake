...
if(NOT DEFINED RULES_DEFINED)
  ...
  set(MUTLIPROCESSOR OFF CACHE BOOL "MUTLIPROCESSOR")
  mark_as_advanced(FORCE MUTLIPROCESSOR)
...
foreach(CHANGED RANGE 5)
  ...
  # Rule: MUTLIPROCESSOR.
  if(MUTLIPROCESSOR)
    set(MUTLIPROCESSOR-PREV ON CACHE INTERNAL "" FORCE)
    set(DEFINES ${DEFINES} MUTLIPROCESSOR)
    # Set flags APIC.
    set(APIC ON CACHE BOOL "APIC" FORCE)
    set(DEFINES ${DEFINES} APIC)
  else(MUTLIPROCESSOR)
    if(MUTLIPROCESSOR-PREV STREQUAL ON)
      set(MUTLIPROCESSOR-PREV OFF CACHE INTERNAL "" FORCE)
      list(REMOVE_ITEM DEFINES APIC)
    endif(MUTLIPROCESSOR-PREV STREQUAL ON)
  endif(MUTLIPROCESSOR)
  # Rule: MIPS_COMMON.
  if(MIPS_COMMON)
