...
foreach(CHANGED RANGE 5)
  ...
  if(X64)
    ...
    # Set flags ADDITIONAL_CHECKS BITS_64 LITTLE_ENDIAN KERNEL_STANDALONE X86_COMMON DEBUGGER_QWERTY.
    ...
    if(X64-PREV STREQUAL ON)
      ...
      list(REMOVE_ITEM DEFINES DEBUGGER_QWERTY)
  ...
  if(MIPS32)
    ...
    set(DEFINES ${DEFINES} MIPS32)
    # Set flags DEBUGGER MIPS_COMMON BITS_32 LITTLE_ENDIAN DEBUGGER_QWERTY.
  ...
  if(X86)
    ...
    # Set flags ADDITIONAL_CHECKS BITS_32 LITTLE_ENDIAN KERNEL_STANDALONE X86_COMMON DEBUGGER_QWERTY.
    set(ADDITIONAL_CHECKS ON CACHE INTERNAL "ADDITIONAL_CHECKS" FORCE)
    set(DEFINES ${DEFINES} ADDITIONAL_CHECKS)
    set(BITS_32 ON CACHE INTERNAL "BITS_32" FORCE)
    set(DEFINES ${DEFINES} BITS_32)
  ...
  if(ARM926E)
    ...
    set(DEFINES ${DEFINES} ARM926E)
    # Set flags ARM_COMMON BITS_32 LITTLE_ENDIAN DEBUGGER_QWERTY.
