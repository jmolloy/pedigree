...
if(NOT DEFINED RULES_DEFINED)
  ...
  set(THREADS OFF CACHE BOOL "THREADS")
  ...
  set(PPC_IBOOK OFF CACHE BOOL "PPC_IBOOK")
  ...
  set(PPC_POWERMAC OFF CACHE BOOL "PPC_POWERMAC")
...
foreach(CHANGED RANGE 5)
  ...
  # Rule: PPC_IBOOK.
  if(PPC_IBOOK)
    set(PPC_IBOOK-PREV ON CACHE INTERNAL "" FORCE)
    set(DEFINES ${DEFINES} PPC_IBOOK)
    # Set flags PPC_COMMON.
    set(PPC_COMMON ON CACHE INTERNAL "PPC_COMMON" FORCE)
    set(DEFINES ${DEFINES} PPC_COMMON)
  else(PPC_IBOOK)
    if(PPC_IBOOK-PREV STREQUAL ON)
      set(PPC_IBOOK-PREV OFF CACHE INTERNAL "" FORCE)
      set(PPC_COMMON OFF CACHE INTERNAL "PPC_COMMON" FORCE)
      list(REMOVE_ITEM DEFINES PPC_COMMON)
    endif(PPC_IBOOK-PREV STREQUAL ON)
  endif(PPC_IBOOK)
  ...
  # Rule: PPC_POWERMAC.
  if(PPC_POWERMAC)
    set(PPC_POWERMAC-PREV ON CACHE INTERNAL "" FORCE)
    set(DEFINES ${DEFINES} PPC_POWERMAC)
    # Set flags PPC_COMMON.
    set(PPC_COMMON ON CACHE INTERNAL "PPC_COMMON" FORCE)
    set(DEFINES ${DEFINES} PPC_COMMON)
  else(PPC_POWERMAC)
    if(PPC_POWERMAC-PREV STREQUAL ON)
      set(PPC_POWERMAC-PREV OFF CACHE INTERNAL "" FORCE)
      set(PPC_COMMON OFF CACHE INTERNAL "PPC_COMMON" FORCE)
      list(REMOVE_ITEM DEFINES PPC_COMMON)
    endif(PPC_POWERMAC-PREV STREQUAL ON)
  endif(PPC_POWERMAC)
