...
opts.AddVariables(
    ...
    ListVariable('CFLAGS', 'Sets the C compiler flags.', 'all', []),
    ListVariable('CCFLAGS', 'Sets the C/C++ generic compiler flags.', 'all', []),
    ListVariable('CXXFLAGS', 'Sets the C++ compiler flags.', 'all', []),
    ListVariable('ASFLAGS', 'Sets the assembler flags.', 'all', []),
    ListVariable('LINKFLAGS', 'Sets the linker flags', 'all', []),
