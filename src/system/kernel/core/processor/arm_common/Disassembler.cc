...
void Arm926EDisassembler::disassembleSpecial(uint32_t nInstruction, LargeStaticString & text)
{
...
void Arm926EDisassembler::disassembleRegImm(uint32_t nInstruction, LargeStaticString & text)
{
  uint32_t nRs = (nInstruction >> 21)&0x1F;
...
void Arm926EDisassembler::disassembleOpcode(uint32_t nInstruction, LargeStaticString & text)
{
