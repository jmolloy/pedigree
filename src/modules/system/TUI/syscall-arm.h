...
{
    long num = ((TUI_SYSCALL_SERVICE&0xFFFF) << 16) | (function&0xFFFF);
    long ret;
    asm volatile("mov r0, %1; \
                  swi #0; \
                  mov %0, r0" : "=r" (ret) : "r" (num));
    return ret;
}
...
static long syscall2(long function, long p1, long p2)
{
    ...
    asm volatile("mov r0, %1; \
                  ...
                  mov r2, %1; \
                  swi #0; \
                  mov %0, r0" : "=r" (ret) : "r" (num), "r" (p1), "r" (p2));
    return ret;
}
...
static long syscall3(long function, long p1, long p2, long p3)
{
    ...
    asm volatile("mov r0, %1; \
                  ...
                  mov r3, %1; \
                  swi #0; \
                  mov %0, r0" : "=r" (ret) : "r" (num), "r" (p1), "r" (p2), "r" (p3));
    return ret;
}
