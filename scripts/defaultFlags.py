...
# x64 final variables
x64_cflags = default_x64_cflags + generic_cflags.replace("-O2", "-O0") + warning_flags + warning_flags_c + warning_flags_off
x64_cxxflags = default_x64_cxxflags + generic_cxxflags.replace("-O2", "-O0") + warning_flags + warning_flags_cxx + warning_flags_off
