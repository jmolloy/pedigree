...
Process::Process() :
  ...
  m_pUser(0), m_pGroup(0), m_PendingSignals(), m_SignalHandlers(), m_SigReturnStub(0), m_SignalMask(0), m_DeadThreads(0), m_SignalHandlersLock(false), m_PendingSignalsLock(false)
{
...
Process::Process(Process *pParent) :
  ...
  m_SignalMask(pParent->m_SignalMask), m_DeadThreads(0), m_SignalHandlersLock(false), m_PendingSignalsLock(false)
{
